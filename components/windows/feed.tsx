      ...
      >
        <div className="title-bar" style={{ cursor: "grab" }}>
          <div className="title-bar-text" style={{ display: "flex", alignItems: "center", gap: "5px" }}>
            <Activity size={14} /> Actividad Reciente - Trophyd
          </div>
        ...
        <div className="window-body has-space" style={{ margin: 0, padding: "10px" }}>
        ...
        <div className="status-bar" style={{ margin: 0 }}>
          <p className="status-bar-field">Logs: {feed.length}</p>
          <p className="status-bar-field">Actividad Global</p>
        </div>
